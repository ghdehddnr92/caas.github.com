...
```liquid
{% raw %}
{% include image.html file="dapTalk/jekyll.png" url="http://jekyllrb.com" alt="Jekyll" caption="This is a sample caption" %"}
{% endraw %}
```
...
Click the **Android SDK Manager** button {% include inline_image.html file="dapTalk/androidsdkmanagericon.png" alt="SDK button" %}
...
```liquid
{% raw %}{% include image.html file="dapTalk/helpapi.svg" url="http://idratherbewriting.com/documentation-theme-jekyll/mydoc_help_api/" alt="Building a Help API" caption="A help API provides a JSON file at a web URL with content that can be pulled into different targets" max-width="600" %}{% endraw %}
```

Here's the result:


{% include image.html file="dapTalk/helpapi.svg" url="http://idratherbewriting.com/documentation-theme-jekyll/mydoc_help_api/" alt="Building a Help API" caption="A help API provides a JSON file at a web URL with content that can be pulled into different targets" max-width="600" %}
...
{% include image.html file="dapTalk/illustratoroptions.png" caption="Essential options for SVG with Illustrator" %}
